...
savefiledirs1 = sprintf('%s%s/workdir/stage1/%3.3i/', ...
  configf.workdir, simname, savetr);% directory for stage 1 results
savefiles1 = sprintf('%s%s/workdir/stage1/%3.3i/results_%3.3i', ...
  configf.workdir, simname, savetr, s1cont);% file for stage 1 results
savefiledirs2 = sprintf('%s%s/workdir/stage2/%3.3i/', ...
  configf.workdir, simname, savetr);% directory for stage 2 results
savefiles2 = sprintf('%s%s/workdir/stage2/%3.3i/results_%3.3i', ...
